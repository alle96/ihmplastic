...
var datePickerController = (function datePickerController() {
    ...
    datePicker.prototype.updateStatus = function(msg) {
        ...
        if(msg && this.statusFormat.search(/%S/) != -1 && msg.search(/([0-9]{1,2})(\uC77C|\uC77C|\uC77C|\uC77C)/) != -1) {
            msg = cbSplit(msg.replace(/([0-9]{1,2})(\uC77C|\uC77C|\uC77C|\uC77C)/, "$1<sup>$2</sup>"), /<sup>|<\/sup>/);
    ...
    datePicker.prototype.setDateFromInput = function() {
        var origDateSet = this.dateSet,
            ...
            eosRegExp   = /(3[01]|[12][0-9]|0?[1-9])(\uC77C|\uC77C|\uC77C|\uC77C)/i,
            elemCnt     = 0,
            dt          = false,
    ...
    var printFormattedDate = function(date, fmt, useImportedLocale) {
        ...
        var d           = date.getDate(),
            ...
            flags       = {
                        ...
                        "Y":y,
                        "S":["\uC77C", "\uC77C", "\uC77C", "\uC77C"][d % 10 > 3 ? 0 : (d % 100 - d % 10 != 10) * d % 10]
                        },
            len         = fmtParts.length,
            currFlag, f;
